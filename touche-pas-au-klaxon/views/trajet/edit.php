...
<form method="post" action="/trajet/<?= $trajet->id ?>/modifier" class="col-md-6">
    ...
    <div class="mb-3">
        ...
        <div class="form-text">
            <?= $trajet->nbPlacesTotal - $trajet->nbPlacesDispo ?> place(s) déjà réservée(s) — le total ne peut pas descendre en dessous.
        </div>
    </div>
